...
export default function Home() {
  ...
  return (
    <main className="cf-home">
      ...
      >
        ...
        <div className="cf-container cf-introduction__grid">
          ...
          <div className="cf-introduction__content">
            ...
            <p>
              At the heart of the initiative is a
              simple principle: partnership
      ...
      <section className="cf-program">

        <div className="cf-container cf-program__grid">
          ...
          <div className="cf-program__intro">
            ...
            <p className="cf-program__intro-text">
        ...
        <div className="cf-container cf-program__footer">
...
<section className="cf-ecosystem">
  ...
  <div className="cf-container cf-ecosystem__grid">
    ...
    <div className="cf-ecosystem__intro">
      ...
      <p>
        A global network of institutions and
        organizations working toward shared
        opportunity.
      </p>
  ...
  <div className="cf-container cf-partners__grid">
    ...
    <div className="cf-partners__content">
      ...
      <p className="cf-partners__lead">
        Continental Founders™️ brings universities,
        businesses, government, investors, and
        innovation leaders together to create
        meaningful opportunities across Africa
        and the United States.
      </p>


      <p className="cf-partners__description">
        Strategic partners can contribute expertise,
        funding, networks, mentorship, technology,
        research, and other resources that help
        strengthen the Continental Founders™️
        ecosystem and expand opportunities for
        emerging entrepreneurs and institutions.
      </p>
